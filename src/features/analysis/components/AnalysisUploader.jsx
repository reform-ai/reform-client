...
import { isUserLoggedIn, getUserToken } from '../../../shared/utils/authStorage';
import { uploadVideoOnly } from '../../../shared/utils/uploadHandler';
import { createErrorWithData } from '../../../shared/utils/apiErrorHandler';
import { getVideoDuration, getVideoFPS } from '../../../shared/utils/videoDuration';
import FileUploader from '../../../shared/components/upload/FileUploader';
import ExerciseSelector from '../../../shared/components/upload/ExerciseSelector';
import NotesInput from '../../../shared/components/upload/NotesInput';
import UploadProgress from '../../../shared/components/upload/UploadProgress';
import UploadError from '../../../shared/components/upload/UploadError';
import AnonymousLimitMessage from '../../../shared/components/upload/AnonymousLimitMessage';
import '../../styles/AnalysisSkeleton.css';

/**
 * AnalysisUploader - Core upload and analysis functionality component
 * 
 * Props:
